 ...
 */
export const compileThemeVariables = (themeScssPath, defaultLessPath = 'antd/lib/style/themes/default.less') => {
  const themeEntryPath = require.resolve(defaultLessPath);
